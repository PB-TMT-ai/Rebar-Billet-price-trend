...
import { UnifiedTmtTab } from '../components/UnifiedTmtTab'
...
type TabKey = 'trend' | 'delta' | 'unified'
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        {/* Tab navigation */}
        <div className={`${activeTab !== 'unified' ? 'mt-8' : ''} flex gap-1 border-b border-slate-200`}>
          <button
        ...
        <div className="mt-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          {activeTab === 'unified' && <UnifiedTmtTab />}
        </div>
